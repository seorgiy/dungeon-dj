...
## Настройка foobar
(Это не нужно делать, если вы скачали foobar вместе с DungeonDJ — тогда он уже настроен)
...
1. Скачайте дополнительный [компонент](https://fy.3dyd.com/download/), это своего рода библиотека для foobar. Версия `foo_youtube_3.9_beta2` должна подойти. Если вы скачали foobar вместе с DungoneDJ — сразу переходите  использованию, всё уже работает.
